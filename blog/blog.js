(() => {
  ...
  const posts = [
    ...
    },
    {
      ...
      theme: "Real-World Systems",
      time: "9 min",
      summary: "An industrial inspection route has to be feasible, conflict-aware, energy-aware, and recoverable. Distance is one input to a safety and operations decision, not the decision by itself.",
    ...
    },
    {
      ...
      theme: "Real-World Systems",
      time: "8 min",
      summary: "Elevator dispatch is a compact example of a larger real-world systems problem: demand changes over time, the full state is not observable, several assets act as a team, and the controller must respect service and safety boundaries.",
